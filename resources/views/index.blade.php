    ...
    <div class="z-10 " id="cover" onfocus="">
        ...
        <form action="{{ route('send-email') }}" method="post">
            ...
            <div class="">
                ...
                <hr>
                <div id="" onclick="">
                    <input class="w-full text-xl   pl-3" type="text" name="receiveName" placeholder="ชื่อผู้รับ" autocomplete="off">
                </div>
                <hr>
                <div class="relative">
                    <textarea id="card_content" name="body" class=" w-full relative left-1/3 w-1/3 md:left-0 text-xl block pl-3" maxlength="100" autocomplete="off" onkeydown="inputSize()" onkeyup="inputSize()"></textarea>
            ...
            <div id="tweet-button">
                <a rel="canonical" href="https://twitter.com/intent/tweet" class="twitter-share-button" data-show-count="false" data-size="large" data-via="KUredcross" data-text="post card">Tweet</a>
