...
@section('content')
    ...
    <div class=" mt-5 border-4 border-light-blue-500 border-opacity-50 w-full md:w-1/2 mx-auto">
                ...
                <form action="{{ route('send-email') }}" method="post">
                    ...
                    <div class="">
                        ...
                        <div>
                            ...
                            <hr>
                            <div class="relative">
                                <textarea id="card_content" name="body" class=" w-full relative w-1/3 text-xl block pl-3"
                                    maxlength="100" autocomplete="off" onkeydown="inputSize()"
