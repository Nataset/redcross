...
@section('content')
    <div>
        ...
        <div id="loading"
            class="fixed w-screen h-screen opacity-75 bg-gray-400 flex flex-col justify-center items-center z-50 hidden">
                    ...
                    <form action="{{ route('send-email', ['img_name' => $img_name]) }}" method="post">
                        ...
                        <div class=" px-4 py-6 text-md md:text-xl  space-y-3">
                            ...
                            <div v-if="mail" class="mb-2 space-y-3" id="" onclick="">
                                ...
                                <input
                                    class="w-full text-xl pl-3 py-2 bg-gray-100 @error('senderName') border-red-400 border-2 @enderror"
                                    type="text" name="senderName" placeholder="ผู้ส่ง" autocomplete="off">
                                @error('senderName')
                                    <div>
                                ...
                                <table>
                                    <tbody>
                                        <tr>
                                            ...
                                            <td class="w-full">
                                                <div class="">
                                                    <input id="toEmail" class="w-full  py-2 pl-2" type="email"
                                                        name="toEmail" onblur="showDiv()">
                                                </div>
                                            </td>
                                        </tr>
                                    </tbody>
                            ...
                            <div v-if="mail" class="mb-2 space-y-3 " id="first" onclick="showSendDiv()">
                                <label for="receiverEmail" class="font-bold">อีเมลผู้รับ</label>
                                <h1
                                    class="bg-gray-50 text-gray-400 px-3 py-2 font-medium text-xl @error('toEmail') border-red-400 border-2 @enderror">
                                    ผู้รับ</h1>
                                @error('toEmail')
                                    <div>
                                        <span class="text-red-600">{{ $message }}</span>
                            ...
                            <div v-if="mail" class="space-y-3">
                                ...
                                <input
                                    class="w-full text-xl py-2 pl-3 bg-gray-100 @error('receiveName') border-red-400 border-2 @enderror"
                                    type="text" name="receiveName" placeholder="ชื่อผู้รับ" autocomplete="off">
                                @error('receiveName')
                                    <div>
                                        <span class="text-red-600">{{ $message }}</span>
                                    </div>
                            ...
                            <div class="relative space-y-3">
                                ...
                                <textarea id="card_content" name="body" v-model="message"
                                    class=" w-full relative text-xl block pl-3 py-3 bg-gray-100 @error('body') border-red-400 border-2 @enderror"
                                    maxlength="90" autocomplete="off" onkeydown="inputSize()" onkeyup="inputSize()"
                            ...
                            <div class="text-center ">
                                <button type="submit" v-if="mail" onclick="showLoading()"
                        ...
                        <div v-if="tweet" class="text-center mt-8">
                            <form action="{{ route('tweet', ['img_name' => $img_name]) }}" method="post">
                                ...
                                <button class="my-8" type="submit">
                                    <a v-if="tweet" rel="canonical" :href="tweetUrl" data-show-count="false"
