            ...
            <tbody>
                ...
                <tr class="border-2 border-gray-600 text-xl">
                    ...
                    <td class="border-2 py-3 px-4 border-gray-600">
                        <a href="{{ url('/edit/product/' . $product->id) }} " class="bg-yellow-400 px-6 py-1 rounded-lg font-bold mx-2 my-2 hover:bg-yellow-200 hover:text-gray-900  ">Edit</a>
                    </td>
                </tr>
                @endforeach
            </tbody>
        </table>
        <a href="{{ route('add')}}" class="bg-yellow-400 px-6 py-1 rounded-lg font-bold mx-2 my-2 hover:bg-yellow-200 hover:text-gray-900">Add Product</a>
    </x-slot>
</x-app-layout>